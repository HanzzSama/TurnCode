        ...
        <div class="certificate-inner">
            ...
            <div class="certificate-content">
                ...
                <div class="cert-description">
                    ...
                    <strong>{{ $course->title }}</strong> sebagai bukti penguasaan materi teoretis dan pemahaman logika
            ...
            <div class="certificate-patterns">
                ...
                <div class="cert-qr-container">
                    <div class="cert-qr-code">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data={{ urlencode(url()->current()) }}&color=0b1528&bgcolor=faf8f5"
                            alt="QR Verification">
                    </div>
                    <div class="cert-qr-info">
                        ...
                        <div class="cert-qr-id">ID:
                            TC-FOC-{{ strtoupper(substr(md5($user->id . $completionDate->timestamp . $course->id), 0, 8)) }}
                        </div>
                    </div>
                </div>
            </div>
