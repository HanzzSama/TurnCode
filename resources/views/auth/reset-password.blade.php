...
<head>
    ...
    <title>Atur Ulang Password - TurnCode</title>
...
<body class="auth-page">
    ...
    <div class="auth-wrapper">
        ...
        <!-- Right Side: Minimalist Reset Password Form -->
        <div class="auth-right">
            <div class="auth-form-container">
                ...
                <div class="auth-subtitle-row" style="max-width: 320px; line-height: 1.5; margin-bottom: 2rem;">
                    Silakan masukkan password baru Anda di bawah ini untuk mengamankan akun Anda.
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" style="width: 100%;">
                    ...
                    <div class="form-group-minimal @error('email') has-error @enderror">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" placeholder="name@email.com" required autocomplete="username" class="field-input">
                    </div>
                    @error('email')
                    ...
                    <div class="form-group-minimal @error('password') has-error @enderror">
                        ...
                        <div class="field-input-wrapper">
                            <input type="password" id="password" name="password" placeholder="Min. 8 karakter" required autocomplete="new-password" class="field-input">
                    ...
                    <div class="form-group-minimal @error('password_confirmation') has-error @enderror">
                        ...
                        <div class="field-input-wrapper">
                            <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Ulangi password baru" required autocomplete="new-password" class="field-input">
                            <button type="button" class="password-toggle" onclick="togglePasswordVisibility('password_confirmation', this)" aria-label="Tampilkan sandi">
                                <svg class="eye-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
                                </svg>
                            </button>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="btn-minimal-submit">Simpan Sandi Baru</button>
                </form>
